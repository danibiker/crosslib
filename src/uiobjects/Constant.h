...
//        map_add,
    ...
    static const int ZOOMINCREMENT = 1; //Incremento de zoom que se aplicara a la imagen
    static const int MOVEINCREMENT = 20; //Pixels que se desplazara la imagen con una pulsacion
