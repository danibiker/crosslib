...
${OBJECTDIR}/_ext/19a342fa/listGroupElement.o: ../src/uiobjects/beans/listGroupElement.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DSKIP_HOSTNAME_VERIFICATION -DSKIP_PEER_VERIFICATION -DWIN -DWIN32 -I../src/httpcurl -I../src/rijndael -I../src/uiobjects -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/19a342fa/listGroupElement.o ../src/uiobjects/beans/listGroupElement.cpp
